...
module "gcp-executors" {
  ...
  job_num_cpus                             = var.executor_job_num_cpus != "6.6.666" ? var.executor_job_num_cpus : var.executor_firecracker_num_cpus
  job_memory                               = var.executor_job_memory != "6.6.666" ? var.executor_job_memory : var.executor_firecracker_memory
