...
module "gcp-executors" {
  ...
  job_num_cpus                        = var.executor_job_num_cpus != "" ? var.executor_job_num_cpus : var.firecracker_num_cpus
  job_memory                          = var.executor_job_memory != "" ? var.executor_job_memory : var.firecracker_memory
